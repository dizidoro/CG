...
public class Layout implements IGraphicLayout {
	...
	public void addListenerController(IGraphicController listener) {
		graphicPanel.addListenerController(listener);
	}
	
	public void addListenerLayout(IGraphicLayout listener) {
		graphicPanel.addListenerLayout(listener);
	}
	...
	private void initialize() {
		...
		frmComputerGraphics.setTitle("Computer graphic - Viewport");
		...
		graphicPanel.setBorder(new CompoundBorder(new LineBorder(new Color(0, 0, 0)), null));
		graphicPanel.setBackground(Color.WHITE);
		frmComputerGraphics.getContentPane().add(graphicPanel, "cell 1 1,grow");
		...
		tglbtnPencil.addActionListener(new ActionListener() {
	        ...
	        public void actionPerformed(ActionEvent e) {
	            ...
	            graphicPanel.setGraphicTool(ObjectType.DOT);
	        }
	    });
		...
		tglbtnLine.addActionListener(new ActionListener() {
	        ...
	        public void actionPerformed(ActionEvent e) {
	            ...
	            graphicPanel.setGraphicTool(ObjectType.LINE);
	        }
	    });
		...
		tglbtnPolygon.addActionListener(new ActionListener() {
	        ...
	        public void actionPerformed(ActionEvent e) {
	            ...
	            graphicPanel.setGraphicTool(ObjectType.POLYGON);
	        }
	    });
		...
		btnMoveUp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Point location = graphicPanel.getLocation();
				graphicPanel.setLocation(location.x, --location.y);
			}
		});
